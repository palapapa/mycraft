...
pub struct WgpuResource {
    ...
    /// [`crate::bevy_resources::winit::WinitResource::window`] so that it is
    /// dropped before it in order to not cause a segfault. See
    ...
    /// [`crate::bevy_resources::winit::WinitResource::window`] in an
